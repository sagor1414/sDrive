...
import '../../view_file/view/view_file_screen.dart';
        ...
        GetX<FileScreenController>(builder: (FileScreenController controller) {
          return SizedBox(
            ...
            child: ListView.builder(
                itemCount: controller.recentfilesList.length > 5
                    ? 5
                    : controller.recentfilesList.length,
                  ...
                  return InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            controller.recentfilesList[index].fileType ==
                                    "image"
                                ? ClipRRect(
                            ...
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: textStyle(
                                    13, Colors.black, FontWeight.w300),
